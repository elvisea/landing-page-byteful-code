export const websiteSchema = {
  ...
  description: "Empresa especializada em desenvolvimento de software, aplicativos e sistemas web personalizados em Curitiba.",
...
export const organizationSchema = {
  ...
  url: "https://bytefulcode.tech",
  image: [
    "https://bytefulcode.tech/og-image.png"
  ],
  description: "Desenvolvimento de software personalizado em Curitiba. Especialistas em criação de aplicativos, sistemas web e soluções digitais inovadoras.",
  foundingDate: "2023",
  founders: [
    {
      "@type": "Person",
      ...
      sameAs: [
        "https://github.com/elvisea",
        "https://www.linkedin.com/in/elvisea"
      ]
    }
  ],
  address: {
