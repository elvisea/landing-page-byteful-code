    ...
    >
      <div className="container mx-auto px-4">
        <div className={sectionHeader.wrapper}>
          ...
          <p className={`${sectionHeader.subtitle} mb-12`}>{t('contact.subtitle')}</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className={`${cardStyles.default} p-8 text-center flex flex-col items-center`}>
              ...
              <h3 className={`${fontSize.xl} ${fontWeight.semibold} ${textColor.primary} mb-2`}>
                {cards[0].title}
              </h3>
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl shadow-xl overflow-hidden">
            <div className="p-8 sm:p-10 text-center">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">{t('contact.cta.subtitle')}</p>
    ...
    return (
      <div className="max-w-2xl mx-auto p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <p className={`${textColor.secondary} mb-8`}>{t('form.success.subtitle')}</p>
          <Link href="/" passHref>
