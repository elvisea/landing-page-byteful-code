...
export const metadata: Metadata = {
  ...
  description: "Entre em contato com a BytefulCode. Estamos prontos para transformar sua ideia em realidade. Solicite um orçamento para seu projeto de software, aplicativo ou sistema web.",
  keywords: [
    // Contato e Orçamento
    "contato bytefulcode",
    "orçamento software",
